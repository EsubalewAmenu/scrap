...
public final class ActivityGeography2008Binding implements ViewBinding {
    public final ToolbarBinding app;
    public final Button cancelReport;
    public final ProgressBar highScoreGeography2008;
    ...
    public final TextView resultTextGeography2008;
    ...
    private ActivityGeography2008Binding(RelativeLayout relativeLayout, ToolbarBinding toolbarBinding, Button button, ProgressBar progressBar, TextView textView, ImageView imageView, TextView textView2, RecyclerView recyclerView, ScrollView scrollView, CardView cardView, TextView textView3, ScrollView scrollView2, RelativeLayout relativeLayout2, Button button2, TextView textView4, TextView textView5) {
        ...
        this.resultTextGeography2008 = textView3;
    ...
    public static ActivityGeography2008Binding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static ActivityGeography2008Binding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C2719R.C2724layout.activity_geography2008, viewGroup, false);
        if (z) {
    ...
    public static ActivityGeography2008Binding bind(View view) {
        View view2 = view;
        ...
        if (findChildViewById != null) {
            ...
            if (button != null) {
                i = C2719R.C2722id.highScore_geography2008;
                ProgressBar progressBar = (ProgressBar) ViewBindings.findChildViewById(view2, C2719R.C2722id.highScore_geography2008);
                if (progressBar != null) {
                            ...
                            if (textView2 != null) {
                                ...
                                if (recyclerView != null) {
                                    ...
                                    if (scrollView != null) {
                                        ...
                                        if (cardView != null) {
                                            i = C2719R.C2722id.resultTextGeography2008;
                                            TextView textView3 = (TextView) ViewBindings.findChildViewById(view2, C2719R.C2722id.resultTextGeography2008);
                                            if (textView3 != null) {
                                                ...
                                                if (scrollView2 != null) {
                                                    ...
                                                    if (button2 != null) {
                                                        ...
                                                        if (textView4 != null) {
                                                            ...
                                                            if (textView5 != null) {
                                                                return new ActivityGeography2008Binding(relativeLayout, bind, button, progressBar, textView, imageView, textView2, recyclerView, scrollView, cardView, textView3, scrollView2, relativeLayout, button2, textView4, textView5);
                                                            }
                                                        }
                                                    }
                                                }
