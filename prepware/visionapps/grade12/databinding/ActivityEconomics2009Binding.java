...
public final class ActivityEconomics2009Binding implements ViewBinding {
    public final ToolbarBinding app;
    public final Button cancelReport;
    public final TextView directions;
    public final ProgressBar highScoreEconomics2009;
    ...
    public final TextView resultTextEconomics2009;
    ...
    private ActivityEconomics2009Binding(RelativeLayout relativeLayout, ToolbarBinding toolbarBinding, Button button, TextView textView, ProgressBar progressBar, TextView textView2, ImageView imageView, TextView textView3, RecyclerView recyclerView, ScrollView scrollView, CardView cardView, TextView textView4, ScrollView scrollView2, RelativeLayout relativeLayout2, Button button2, TextView textView5, TextView textView6) {
        ...
        this.resultTextEconomics2009 = textView4;
    ...
    public static ActivityEconomics2009Binding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static ActivityEconomics2009Binding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C2719R.C2724layout.activity_economics2009, viewGroup, false);
        if (z) {
    ...
    public static ActivityEconomics2009Binding bind(View view) {
        View view2 = view;
        ...
        if (findChildViewById != null) {
            ...
            if (button != null) {
                ...
                if (textView != null) {
                    i = C2719R.C2722id.highScore_economics2009;
                    ProgressBar progressBar = (ProgressBar) ViewBindings.findChildViewById(view2, C2719R.C2722id.highScore_economics2009);
                    if (progressBar != null) {
                                ...
                                if (textView3 != null) {
                                    ...
                                    if (recyclerView != null) {
                                        ...
                                        if (scrollView != null) {
                                            ...
                                            if (cardView != null) {
                                                i = C2719R.C2722id.resultTextEconomics2009;
                                                TextView textView4 = (TextView) ViewBindings.findChildViewById(view2, C2719R.C2722id.resultTextEconomics2009);
                                                if (textView4 != null) {
                                                    ...
                                                    if (scrollView2 != null) {
                                                        ...
                                                        if (button2 != null) {
                                                            ...
                                                            if (textView5 != null) {
                                                                ...
                                                                if (textView6 != null) {
                                                                    return new ActivityEconomics2009Binding(relativeLayout, bind, button, textView, progressBar, textView2, imageView, textView3, recyclerView, scrollView, cardView, textView4, scrollView2, relativeLayout, button2, textView5, textView6);
                                                                }
                                                            }
                                                        }
                                                    }
