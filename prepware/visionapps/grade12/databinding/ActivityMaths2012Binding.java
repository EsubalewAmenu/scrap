...
public final class ActivityMaths2012Binding implements ViewBinding {
    ...
    public final TextView resultTextMath2012;
    ...
    private ActivityMaths2012Binding(RelativeLayout relativeLayout, ToolbarBinding toolbarBinding, Button button, TextView textView, ProgressBar progressBar, TextView textView2, ImageView imageView, TextView textView3, RecyclerView recyclerView, ScrollView scrollView, CardView cardView, TextView textView4, ScrollView scrollView2, RelativeLayout relativeLayout2, Button button2, TextView textView5) {
        ...
        this.resultTextMath2012 = textView4;
    ...
    public static ActivityMaths2012Binding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static ActivityMaths2012Binding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C2719R.C2724layout.activity_maths2012, viewGroup, false);
        if (z) {
    ...
    public static ActivityMaths2012Binding bind(View view) {
        View view2 = view;
                                ...
                                if (textView3 != null) {
                                    ...
                                    if (recyclerView != null) {
                                        ...
                                        if (scrollView != null) {
                                            ...
                                            if (cardView != null) {
                                                i = C2719R.C2722id.resultTextMath2012;
                                                TextView textView4 = (TextView) ViewBindings.findChildViewById(view2, C2719R.C2722id.resultTextMath2012);
                                                if (textView4 != null) {
                                                    ...
                                                    if (scrollView2 != null) {
                                                        ...
                                                        if (button2 != null) {
                                                            ...
                                                            if (textView5 != null) {
                                                                return new ActivityMaths2012Binding(relativeLayout, bind, button, textView, progressBar, textView2, imageView, textView3, recyclerView, scrollView, cardView, textView4, scrollView2, relativeLayout, button2, textView5);
                                                            }
                                                        }
                                                    }
                                                }
