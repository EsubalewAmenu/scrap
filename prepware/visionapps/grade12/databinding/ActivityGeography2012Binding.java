...
public final class ActivityGeography2012Binding implements ViewBinding {
    ...
    public final ProgressBar highScoreGeography2012;
    ...
    public final TextView resultTextGeography2012;
    ...
    private ActivityGeography2012Binding(RelativeLayout relativeLayout, ToolbarBinding toolbarBinding, Button button, TextView textView, PhotoView photoView, ProgressBar progressBar, TextView textView2, ImageView imageView, TextView textView3, TextView textView4, RecyclerView recyclerView, RecyclerView recyclerView2, ScrollView scrollView, CardView cardView, TextView textView5, ScrollView scrollView2, RelativeLayout relativeLayout2, Button button2, TextView textView6, TextView textView7) {
        ...
        this.resultTextGeography2012 = textView5;
    ...
    public static ActivityGeography2012Binding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static ActivityGeography2012Binding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C2719R.C2724layout.activity_geography2012, viewGroup, false);
        if (z) {
    ...
    public static ActivityGeography2012Binding bind(View view) {
        View view2 = view;
        ...
        if (findChildViewById != null) {
            ...
            if (button != null) {
                ...
                if (textView != null) {
                    ...
                    if (photoView != null) {
                        i = C2719R.C2722id.highScore_geography2012;
                        ProgressBar progressBar = (ProgressBar) ViewBindings.findChildViewById(view2, C2719R.C2722id.highScore_geography2012);
                        if (progressBar != null) {
                                            ...
                                            if (recyclerView != null) {
                                                ...
                                                if (recyclerView2 != null) {
                                                    ...
                                                    if (scrollView != null) {
                                                        ...
                                                        if (cardView != null) {
                                                            i = C2719R.C2722id.resultTextGeography2012;
                                                            TextView textView5 = (TextView) ViewBindings.findChildViewById(view2, C2719R.C2722id.resultTextGeography2012);
                                                            if (textView5 != null) {
                                                                ...
                                                                if (scrollView2 != null) {
                                                                    ...
                                                                    if (button2 != null) {
                                                                        ...
                                                                        if (textView6 != null) {
                                                                            ...
                                                                            if (textView7 != null) {
                                                                                return new ActivityGeography2012Binding(relativeLayout, bind, button, textView, photoView, progressBar, textView2, imageView, textView3, textView4, recyclerView, recyclerView2, scrollView, cardView, textView5, scrollView2, relativeLayout, button2, textView6, textView7);
                                                                            }
                                                                        }
                                                                    }
                                                                }
