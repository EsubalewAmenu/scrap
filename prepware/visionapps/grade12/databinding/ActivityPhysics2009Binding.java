...
public final class ActivityPhysics2009Binding implements ViewBinding {
    ...
    public final ProgressBar highScorePhysics2009;
    ...
    public final TextView resultTextPhysics2009;
    ...
    private ActivityPhysics2009Binding(RelativeLayout relativeLayout, ToolbarBinding toolbarBinding, Button button, TextView textView, Button button2, ProgressBar progressBar, TextView textView2, ImageView imageView, TextView textView3, RecyclerView recyclerView, ScrollView scrollView, CardView cardView, TextView textView4, ScrollView scrollView2, RelativeLayout relativeLayout2, Button button3, TextView textView5, TextView textView6) {
        ...
        this.resultTextPhysics2009 = textView4;
    ...
    public static ActivityPhysics2009Binding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static ActivityPhysics2009Binding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C2719R.C2724layout.activity_physics2009, viewGroup, false);
        if (z) {
    ...
    public static ActivityPhysics2009Binding bind(View view) {
        View view2 = view;
        ...
        if (findChildViewById != null) {
            ...
            if (button != null) {
                ...
                if (textView != null) {
                    ...
                    if (button2 != null) {
                        i = C2719R.C2722id.highScore_physics2009;
                        ProgressBar progressBar = (ProgressBar) ViewBindings.findChildViewById(view2, C2719R.C2722id.highScore_physics2009);
                        if (progressBar != null) {
                                    ...
                                    if (textView3 != null) {
                                        ...
                                        if (recyclerView != null) {
                                            ...
                                            if (scrollView != null) {
                                                ...
                                                if (cardView != null) {
                                                    i = C2719R.C2722id.resultTextPhysics2009;
                                                    TextView textView4 = (TextView) ViewBindings.findChildViewById(view2, C2719R.C2722id.resultTextPhysics2009);
                                                    if (textView4 != null) {
                                                        ...
                                                        if (scrollView2 != null) {
                                                            ...
                                                            if (button3 != null) {
                                                                ...
                                                                if (textView5 != null) {
                                                                    ...
                                                                    if (textView6 != null) {
                                                                        return new ActivityPhysics2009Binding(relativeLayout, bind, button, textView, button2, progressBar, textView2, imageView, textView3, recyclerView, scrollView, cardView, textView4, scrollView2, relativeLayout, button3, textView5, textView6);
                                                                    }
                                                                }
                                                            }
                                                        }
